...
| Cosmic_Retro_Station_Props_FREE | Asset Store | Unity EULA | SF研究所の環境プロップ | `ThirdParty/Cosmic_Retro_Station_Props_FREE/` | 2026-03-14 |
| Free Low Poly Desert Pack | Asset Store | Unity EULA | 砂漠バイオーム / 岩場 / サボテンなどの low poly 環境 | `ThirdParty/Free Low Poly Desert Pack/` | 2026-03-15 |
| Free Low Poly Nature Forest | Asset Store | Unity EULA | 森林バイオーム / 自然地形 / 樹木・草 | `ThirdParty/Pure Poly/Free Low Poly Nature Pack/` | 2026-03-15 |
...
|-----------|--------|-----------|------|---------|-------|
| *(テンプレート)* | Asset Store | Unity EULA | - | `ThirdParty/<名前>/` | YYYY-MM-DD |
| DoubleL | Asset Store | Unity EULA | RPG Animations Pack FREE / 戦闘・移動アニメ | `ThirdParty/DoubleL/` | 2026-03-13 |
| Kevin Iglesias | Asset Store | Unity EULA | Human Basic Motions FREE / 汎用人型アニメ | `ThirdParty/Kevin Iglesias/` | 2026-03-14 |
...
| Fantasy Skybox FREE | Asset Store | Unity EULA | パノラマ / Cubemap の skybox 集 | `ThirdParty/Fantasy Skybox FREE/` | 2026-03-15 |
...
| UnityTechnologies | Asset Store | Unity EULA | Particle Pack / 汎用パーティクル / 炎・火花・煙 | `ThirdParty/UnityTechnologies/ParticlePack/` | 2026-03-15 |
| SimpleFX | Asset Store | Unity EULA | 汎用パーティクル / 火花 / 蒸気 / 爆発 | `ThirdParty/SimpleFX/` | 2026-03-14 |
...
|-----------|--------|-----------|------|---------|-------|
| *(テンプレート)* | Asset Store | Unity EULA | - | `ThirdParty/<名前>/` | YYYY-MM-DD |
| Casual Game Sounds U6 | Asset Store | Unity EULA | FREE Casual Game SFX Pack / UI・軽いアクション向け SE | `ThirdParty/Casual Game Sounds U6/CasualGameSounds/` | 2026-03-15 |
| Free Pack | Asset Store | Unity EULA | Free Sound Effects Pack / 汎用・環境音・ループ向け SE | `ThirdParty/Free Pack/` | 2026-03-15 |
...
| `com.unity.recorder` | 5.1.5 | 動画録画 |
| `com.unity.cinemachine` | 2.10.5 | カメラワーク |
